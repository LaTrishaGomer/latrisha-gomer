    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 x1:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
        ...
        rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50" } `}>
            ...
            <li><a className='font-Ovo' href="#work">Blog</a></li>
        ...
        <div className='flex items-center gap-4'>
            ...
            py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Let's Chat <Image src={assets.arrow_icon} alt='' className='w-3'/></a>
