...
const Services = () => {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>By blending smart design with customer-focused strategy, I develop websites that attract the right audience and drive results.</p>
        ...
        {serviceData.map(({icon, title, description, link}, index) => (
          ...
          className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500'>
            ...
            <a href="#contact" className='flex items-center gap-2 text-sm mt-5'>
                Start project <Image alt='' src={assets.right_arrow} className='w-4'/>
            </a>
          </div>
        ))}
      </div>
